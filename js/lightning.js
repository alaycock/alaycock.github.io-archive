(function(){
  ...
  function Lightning() {
    ...
    function createCircles() {
      ...
      for(var i = 0; i < dotCount; i++) {
        dots[i] = {
          ...
          index: i,
          has_line: false,
          speed: Math.random() * (VELOCITY_MAX - VELOCITY_MIN) + VELOCITY_MIN
        };
      }
    }
    ...
    function triggerLightning(dot1, dot2) {
      if(!dot1.has_line) {
        findWithinRadius(dot1, 0, 150, chainLightning);
      }
    }
    ...
    function chainLightning(dot1, dot2) {
      if(!dot2.has_line) {
        ...
        setTimeout(function() {
          findWithinRadius(dot2, 0, 150, chainLightning);
        }, 60);
      }
    }
  }
